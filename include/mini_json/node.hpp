...
public:
  ...
  using data_t
      = mini_mpf::type_umap<data_k, nil_t, arr_t, obj_t, str_t, num_t, bool>;
...
public:
  ...
  {
    using Pure = std::decay_t<T>;
    static_assert (data_t::find_if<Pure> (),
		   "mini_json::node::get : invalid type");
